...
class ScreensaverManager:
    ...
    def __init__(self):
        ...
        # Effects list (7 effects - memory optimized)
        self.effects = [
            PlasmaEffect(),
            SpiralEffect(),
            MatrixEffect(),
        ...
        print("🎬 Effects: Plasma → Spiral → Matrix → Color Matrix → Julia Fractal → Fire → Sine Waves → repeat")
        print("💾 Memory optimized - 7 effects total (removed Starfield for stability)")
